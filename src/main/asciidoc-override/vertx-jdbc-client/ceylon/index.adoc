...
----
shared import io.vertx.ceylon.jdbc "3.2.2";
----
...
The connection is an instance of `link:../../ceylondoc/vertx-sql//SQLConnection.type.html[SQLConnection]` which is a common interface not only used by
