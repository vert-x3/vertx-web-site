...
`io.vertx:vertx-web-templ-mvel:3.2.1`. Create an instance of the MVEL template engine using:
...
`io.vertx:vertx-web-templ-jade:3.2.1`. Create an instance of the Jade template engine using:
...
`io.vertx:vertx-web-templ-handlebars:3.2.1`. Create an instance of the Handlebars template engine
...
`io.vertx:vertx-web-templ-thymeleaf:3.2.1`. Create an instance of the Thymeleaf template engine
...
inspect the raw message of the event using `link:../../jsdoc/bridge_event-BridgeEvent.html#getRawMessage[getRawMessage]`.
