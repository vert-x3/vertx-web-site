...
Instead, use either the link:/docs/vertx-mysql-client/kotlin/[Reactive MySQL Client] or the link:/docs/vertx-pg-client/kotlin/[Reactive PostgreSQL Client].
...
* vertx-lang-kotlin 3.8.4 (the client)
