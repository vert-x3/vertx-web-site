...
Instead, use either the link:/docs/vertx-mysql-client/java/[Reactive MySQL Client] or the link:/docs/vertx-pg-client/java/[Reactive PostgreSQL Client].
...
* vertx-mysql-postgresql-client 3.8.4 (the client)
