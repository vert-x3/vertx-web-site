...
WARNING: This module is deprecated and will be removed in Vertx 4.0.
Instead, use either the link:/docs/vertx-mysql-client/js/[Reactive MySQL Client] or the link:/docs/vertx-pg-client/js/[Reactive PostgreSQL Client].
...
* vertx-lang-js 3.8.4 (the client)
...
----
compile 'io.vertx:vertx-mysql-postgresql-client:3.8.4'
----
...
it, you should close it using `link:../../jsdoc/module-vertx-sql-js_sql_client-SQLClient.html#close[close]` or
`link:../../jsdoc/module-vertx-sql-js_sql_client-SQLClient.html#close[close]`

== Getting a connection

Use `link:../../jsdoc/module-vertx-sql-js_sql_client-SQLClient.html#getConnection[getConnection]` to get a connection.
...
so any call to `link:../../jsdoc/module-vertx-sql-js_sql_client-SQLClient.html#getConnection[getConnection]`
