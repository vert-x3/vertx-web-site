...
Instead, use either the link:/docs/vertx-mysql-client/groovy/[Reactive MySQL Client] or the link:/docs/vertx-pg-client/groovy/[Reactive PostgreSQL Client].
...
* vertx-lang-groovy 3.8.4 (the client)
