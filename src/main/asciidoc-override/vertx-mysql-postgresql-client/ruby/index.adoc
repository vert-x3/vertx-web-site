...
Instead, use either the link:/docs/vertx-mysql-client/ruby/[Reactive MySQL Client] or the link:/docs/vertx-pg-client/ruby/[Reactive PostgreSQL Client].
...
* vertx-lang-ruby 3.8.4 (the client)
...
so any call to `link:../../yardoc/VertxSql/SQLClient.html#get_connection-instance_method[getConnection]`
