...
These access tokens can then in turn be used to access other services or APIs on behalf of the user. The server providing those services or APIs is often called  `resource server`.
