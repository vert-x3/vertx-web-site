...
Here are some other important new features you can find in this release:

- Java 11 support (unless a module relies on a third-party dependency won't support it yet)
