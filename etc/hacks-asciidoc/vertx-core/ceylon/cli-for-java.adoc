...
The described `link:../../ceylondoc/vertx-core//cli/Option.type.html[Option]` and `link:../../ceylondoc/vertx-core//cli/Argument.type.html[Argument]` classes are _untyped_,
...
Instead of
`link:../../ceylondoc/vertx-core//cli/Option.type.html[Option]` and `link:../../ceylondoc/vertx-core//cli/Argument.type.html[Argument]`, use `TypedOption`
and `TypedArgument` in the `link:../../ceylondoc/vertx-core//cli/CLI.type.html[CLI]` definition:
...
Once annotated, you can define the `link:../../ceylondoc/vertx-core//cli/CLI.type.html[CLI]` and inject the values using:
